...
4. Set `APP_BASE_URL` when image previews need absolute URLs.
5. Run the normal Send Message flow; SMS/LMS/MMS are delivered as Slack-formatted dev/test notifications instead of carrier messages.
