...
3. Record detail pages preserve the correct tab and interaction model for that object family; object-specific exceptions such as the current message-send detail page may use object-level edit actions instead of shared inline-pencil editing.
...
- [ ] **Messaging UI Contract**: Messaging detail templates still resolve from `web/message/frontend/templates/`, and message-send detail keeps its object-level edit contract without regressing into broken shared inline-pencil behavior.
