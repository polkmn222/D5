    ...
    try:
        ...
        if assets:
            related_lists.append({
                ...
                "view_all_url": f"/assets?product={product_id}",
        ...
        if opportunities:
            related_lists.append({
                ...
                "view_all_url": f"/opportunities?product={product_id}",
        ...
        if leads:
            related_lists.append({
                ...
                "view_all_url": f"/leads?product={product_id}",
        ...
        if model_spec:
            related_lists.append({
                ...
                "view_all_url": f"/models/{model_spec.id}",
                "total_count": 1,
        ...
        if brand_spec:
            related_lists.append({
                ...
                "icon": "brand",
                "columns": ["Name", "Type"],
                "view_all_url": f"/vehicle_specifications/{brand_spec.id}",
                "total_count": 1,
