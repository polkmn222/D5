...
class AiAgentService:
    ...
    def _resolve_send_message_request(
        ...
        if not object_type or not ids:
            return {
                "intent": "CHAT",
                "text": "Who should I send the message to? Try `show recent leads`, `show all contacts`, or `show recently created leads`, then select one or more records and ask me to send the message.",
                "score": 1.0,
            }
