...
class OpportunityService(BaseService[Opportunity]):
    ...
    def delete(cls, db: Session, obj_id: str) -> bool:
        try:
            return RecordDeleteService.delete_opportunity(db, obj_id)
        except Exception as e:
            logger.error(f"Critical error in delete: {e}")
            raise e
    ...
    def delete_opportunity(cls, db: Session, opp_id: str) -> bool:
        try:
            return RecordDeleteService.delete_opportunity(db, opp_id)
        except Exception as e:
