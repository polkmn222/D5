    ...
    try:
        ...
        if assets:
            related_lists.append({
                ...
                "view_all_url": f"/assets?product={product_id}&related=1&back_to=/products/{product_id}",
        ...
        if opportunities:
            related_lists.append({
                ...
                "view_all_url": f"/opportunities?product={product_id}&related=1&back_to=/products/{product_id}",
        ...
        if leads:
            related_lists.append({
                ...
                "view_all_url": f"/leads?product={product_id}&related=1&back_to=/products/{product_id}",
        ...
        if model_spec:
            related_lists.append({
                ...
                "view_all_url": f"/models?id={model_spec.id}&related=1&back_to=/products/{product_id}",
                "total_count": 1,
        ...
        if brand_spec:
            related_lists.append({
                ...
                "icon": "brand",
                "columns": ["Name", "Type"],
                "view_all_url": f"/vehicle_specifications?id={brand_spec.id}&related=1&back_to=/products/{product_id}",
                "total_count": 1,
