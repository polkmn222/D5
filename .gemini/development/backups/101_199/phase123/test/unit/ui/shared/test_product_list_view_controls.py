...
def test_related_list_template_supports_back_button_mode():
    html = templates.get_template("related/list_view.html").render({
        "request": build_request(),
        "page_title": "Products",
        "items": [{"name": "EV Package", "brand": "Apex", "model": "Ioniq", "base_price": 1000, "category": "EV", "_href": "/products/product-1", "edit_url": "/products/new-modal?id=product-1"}],
        "columns": ["Name", "Brand", "Model", "Base_Price", "Category"],
        "back_url": "/contacts/contact-1",
        "new_url": None,
        "show_actions": True,
    })

    assert "Back" in html
    assert "/contacts/contact-1" in html
