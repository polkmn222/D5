...
async def new_lead_modal(request: Request, id: str = None, brand: str = None, model: str = None, product: str = None, db: Session = Depends(get_db)):
    try:
...
async def new_lead_modal_base(request: Request, id: str = None, brand: str = None, model: str = None, product: str = None, db: Session = Depends(get_db)):
    try:
        return await new_lead_modal(request, id, brand, model, product, db)
    except Exception as e:
        logger.error(f"Error in lead modal base: {e}")
        return RedirectResponse(url="/leads?error=Error+opening+modal")

@router.get("/leads/new")
async def new_lead_modal_direct(request: Request, id: str = None, brand: str = None, model: str = None, product: str = None, db: Session = Depends(get_db)):
    try:
        return await new_lead_modal(request, id, brand, model, product, db)
    except Exception as e:
