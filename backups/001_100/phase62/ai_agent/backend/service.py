    ...
    async def _execute_intent(
        ...
        if intent == "MODIFY_UI":
            ...
            if any(word in q_low for word in ["compact", "축소", "작게"]):
                ...
                agent_output["intent"] = "CHAT"
                agent_output["text"] = "How would you like to change **AI Recommend** on the home screen? You can choose [Hot Deals], [High Value], [Closing Soon], or [Default]."
        ...
        if intent == "RECOMMEND":
            ...
            agent_output["text"] = f"Here are {len(paged_recommends)} AI-recommended deals for you!"
            return agent_output
