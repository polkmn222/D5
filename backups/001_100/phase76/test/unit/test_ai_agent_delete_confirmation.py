...
DELETE_CASES = [
    ("lead", "delete that lead", "backend.app.services.lead_service", "LeadService", "delete_lead"),
    ("contact", "delete that contact", "backend.app.services.contact_service", "ContactService", "delete_contact"),
    ("opportunity", "delete that opportunity", "backend.app.services.opportunity_service", "OpportunityService", "delete_opportunity"),
    ("brand", "delete that brand", "backend.app.services.vehicle_spec_service", "VehicleSpecService", "delete_vehicle_spec"),
    ("model", "delete that model", "backend.app.services.model_service", "ModelService", "delete_model"),
    ("product", "delete that product", "backend.app.services.product_service", "ProductService", "delete_product"),
    ("asset", "delete that asset", "backend.app.services.asset_service", "AssetService", "delete_asset"),
    ("message_template", "delete that template", "backend.app.services.message_template_service", "MessageTemplateService", "delete_template"),
]
