...
from web.backend.app.api.routers.message_template_router import update_template_route
...
async def test_update_template_route_content(db):
    ...
    with patch("web.backend.app.services.message_template_service.MessageTemplateService.update_template") as mock_update:
        # 1. Test with 'content'
...
async def test_batch_save_template_content(db, request_mock):
    ...
    with patch("web.backend.app.services.message_template_service.MessageTemplateService.get_template") as mock_get, \
         patch("web.backend.app.services.message_template_service.MessageTemplateService.update_template") as mock_update:
