...
async def test_batch_save_lead_name_split(db, request_mock):
    ...
    with patch("backend.app.services.lead_service.LeadService.get_lead") as mock_get, \
         patch("backend.app.services.lead_service.LeadService.update_lead") as mock_update:
...
async def test_batch_save_opportunity_fields(db, request_mock):
    ...
    with patch("backend.app.services.opportunity_service.OpportunityService.get_opportunity") as mock_get, \
         patch("backend.app.services.opportunity_service.OpportunityService.update_opportunity") as mock_update:
