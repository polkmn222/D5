...
def main() -> None:
    run_checklist(
        ...
        """,
        items=[
            ChecklistItem("Contacts CRUD", "Open `/contacts`, create a contact, open the detail page, edit a field, verify list/detail consistency, and delete the record.", "Contact list and detail behavior stays consistent through the full CRUD flow.", area="Contacts", severity="high"),
            ...
            ChecklistItem("Leads CRUD", "Open `/leads`, create a lead, update key fields, verify search visibility, and delete or archive the record.", "Lead CRUD behavior matches expectations in list, search, and detail views.", area="Leads", severity="high"),
            ...
            ChecklistItem("Opportunities CRUD", "Open `/opportunities`, create an opportunity, update amount or stage, and verify list/detail visibility.", "Opportunity updates persist and render correctly after save and refresh.", area="Opportunities", severity="high"),
            ChecklistItem("Assets CRUD", "Open `/assets`, create or edit an asset, verify VIN or related fields, and confirm the detail page renders correctly.", "Asset list/detail behavior and related links remain correct.", area="Assets", severity="medium"),
            ChecklistItem("Products CRUD", "Open `/products`, create or edit a product, and verify related brand/model associations and list/detail rendering.", "Product data persists and related links remain correct.", area="Products", severity="medium"),
            ChecklistItem("Vehicle specs and models", "Use the visible brand/model pages or forms to create or edit a brand/model pair and verify lookup resolution.", "Vehicle spec and model relationships resolve correctly in forms and detail views.", area="Vehicle Specs", severity="medium"),
