...
class AiAgentService:
    ...
    async def process_query(cls, db: Session, user_query: str) -> Dict[str, Any]:
        ...
        - If a user wants to CREATE a record (lead, contact, opportunity, etc.) but hasn't provided mandatory info:
          1. Use intent "CHAT".
          2. Acknowledge the request (e.g., "I'd be happy to help you create a lead!").
          3. Politely ask for the missing information (Name, Email, etc.).
          4. Do NOT use intent "CREATE" until you have at least a Name/Subject.
