...
5. Review or run `test/manual/smoke/smoke_checklist.py` and execute the smoke checks from `manual_checklist.md`.
6. Review or run `test/manual/regression/regression_checklist.py` and execute the relevant CRM regression sections.
