...
graph TD
    ...
    Templates --> SharedUI[web/frontend/templates + ai_agent templates]
```
...
- The CRM UI is rendered through Jinja2 templates under `web/frontend/templates/`.
...
- Route composition lives in `web/backend/app/api/api_router.py`.
