...
async def new_product_modal_base(request: Request, id: str = None, brand: str = None, db: Session = Depends(get_db)):
    try:
        return await new_product_modal(request, id, brand, db)
    except Exception as e:
        logger.error(f"Error in product modal base: {e}")
        return RedirectResponse(url="/products?error=Error+opening+modal")

@router.get("/products/new")
async def new_product_modal(request: Request, id: str = None, brand: str = None, db: Session = Depends(get_db)):
    try:
...
async def new_asset_modal_base(request: Request, id: str = None, brand: str = None, db: Session = Depends(get_db)):
    try:
        return await new_asset_modal(request, id, brand, db)
    except Exception as e:
...
async def new_asset_modal(request: Request, id: str = None, brand: str = None, db: Session = Depends(get_db)):
    try:
