...
def test_messaging_recommendations_match_ai_recommendation_service(monkeypatch):
    ...
    monkeypatch.setattr(AIRecommendationService, "get_sendable_recommendations", lambda db, limit=5, scan_limit=50: [opp])
...
def test_messaging_recommendations_skip_unsendable_items_but_keep_ai_order(monkeypatch):
    ...
    monkeypatch.setattr(AIRecommendationService, "get_sendable_recommendations", lambda db, limit=5, scan_limit=50: [skipped_opp, kept_opp])
