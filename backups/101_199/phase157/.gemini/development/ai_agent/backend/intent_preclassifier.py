...
class IntentPreClassifier:
    ...
    ACTION_READ = ["open", "show", "view", "read", "details", "열어", "보여", "보기", "상세"]
    ACTION_UPDATE = ["edit", "update", "change", "modify", "수정", "변경", "바꿔"]
    ACTION_DELETE = ["delete", "remove", "erase", "삭제"]
    ...
    def detect(cls, text: str) -> Optional[Dict[str, Any]]:
        ...
        if cls._contains_action(normalized, cls.ACTION_UPDATE):
            return {
                "intent": "CHAT",
                "object_type": detected_object,
                "text": f"I can help update a {detected_object}. First show the record you want, select it, then tell me what to change.",
                "score": 0.95,
            }
