...
async def contact_detail(request: Request, contact_id: str, db: Session = Depends(get_db)):
    ...
    if opportunities:
        related_lists.append({
            ...
            "view_all_url": f"/opportunities?contact={contact_id}&related=1&back_to=/contacts/{contact_id}",
    ...
    if messages:
        related_lists.append({
            ...
            "icon": "message",
            "new_url": f"/messages/new-modal?contact={contact_id}",
            "view_all_url": f"/messages?contact={contact_id}&related=1&back_to=/contacts/{contact_id}",
    ...
    if assets:
        related_lists.append({
            ...
            "view_all_url": f"/assets?contact={contact_id}&related=1&back_to=/contacts/{contact_id}",
