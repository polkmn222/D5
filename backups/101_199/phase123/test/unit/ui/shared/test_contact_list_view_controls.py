...
def test_contact_detail_related_lists_include_opportunities_messages_and_assets():
    ...
    assert "/opportunities?contact=contact-1" in response.text
    assert "/messages?contact=contact-1" in response.text
    assert "/assets?contact=contact-1" in response.text
    assert "related=1" in response.text
    assert "back_to=/contacts/contact-1" in response.text
    assert "/opportunities/opp-1" in response.text
    assert "/messages/msg-1" in response.text
    assert "/assets/asset-1" in response.text
    assert "sf-related-icon--opportunity" in response.text
