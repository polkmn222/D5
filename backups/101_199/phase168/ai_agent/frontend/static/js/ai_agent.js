        ...
        <div class="results-container" data-object-type="${objectType || ''}" ${pagination?.table_key ? `data-table-key="${pagination.table_key}"` : ''} data-table-uid="${tableUid}">
            <div class="table-controls">
                ...
                <div class="table-controls-search-row">
                    <input type="text" class="agent-table-search" placeholder="Search in table..." oninput="filterAgentTable(this)" aria-label="Search in table">
                </div>
                <div class="table-controls-btn-row">
                    <button class="control-btn" onclick="selectAllAgentRows(this, '${objectType}')"><span style="margin-right:4px;">☑</span>Select All</button>
                    <button class="control-btn" onclick="clearAllAgentRows(this, '${objectType}')"><span style="margin-right:4px;">☒</span>Clear All</button>
