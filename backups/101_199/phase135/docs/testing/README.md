...
- `manual_strategy.md`: manual test scope, ownership, and environment rules.
- `manual_checklist.md`: smoke and regression checklist for manual verification.
- `manual_runbook.md`: step-by-step manual execution order.

The old `.gemini/development/test/docs/` archive set has been retired. Use the files in this folder as the active source of truth.
