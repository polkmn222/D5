...
function triggerSelectionMessaging() {
    const selection = buildSelectionPayload();
    if (!selection) {
        appendChatMessage('agent', 'Who should I send the message to? Try showing recent leads, all contacts, or recently created leads first, then select one or more records.');
        return;
    }
