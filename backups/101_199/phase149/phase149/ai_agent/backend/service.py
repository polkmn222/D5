...
class AiAgentService:
    ...
    @classmethod
    def _extract_lead_fields_from_text(cls, user_query: str) -> Dict[str, Any]:
    ...
    async def process_query(
        ...
        if rule_based:
            if rule_based.get("intent") == "CHAT" and rule_based.get("object_type") == "lead" and 'create' in user_query.lower():
                ConversationContextStore.remember_pending_create(conversation_id, 'lead', {})
