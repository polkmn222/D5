...
- `web/message/frontend/templates/messages/detail_view.html` is intentionally read-only in the current runtime; do not assume every detail page exposes inline edit affordances.
