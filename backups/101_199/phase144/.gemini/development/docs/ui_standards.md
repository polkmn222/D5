...
- Exception: do not add pencil icons to views that are intentionally read-only. The current `messages/detail_view.html` implementation is a valid read-only exception and should be tested as such.
