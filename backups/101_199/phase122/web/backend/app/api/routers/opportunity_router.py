    ...
    try:
        ...
        if contact:
            related_lists.append({
                ...
                "icon": "contact",
                "view_all_url": f"/contacts/{contact.id}",
                "total_count": 1,
                "items": [{
        ...
        if product:
            related_lists.append({
                ...
                "icon": "product",
                "view_all_url": f"/products/{product.id}",
                "total_count": 1,
                "items": [{
        ...
        if asset:
            related_lists.append({
                ...
                "icon": "asset",
                "view_all_url": f"/assets/{asset.id}",
                "total_count": 1,
                "items": [{
                    "name": asset.name or "",
                    "vin": asset.vin or "",
        ...
        if model:
            related_lists.append({
                ...
                "icon": "model",
                "view_all_url": f"/models/{model.id}",
                "total_count": 1,
                "items": [{
                    "name": model.name or "",
        ...
        if brand:
            related_lists.append({
                ...
                "columns": ["Name", "Type"],
                "icon": "brand",
                "view_all_url": f"/vehicle_specifications/{brand.id}",
                "total_count": 1,
                "items": [{
                    "name": brand.name or "",
