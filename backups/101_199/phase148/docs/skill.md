...
- Prefer chat-embedded pasted cards for the lead CRU path when the goal is to keep the user inside the AI conversation rather than bouncing them into a separate workspace.
