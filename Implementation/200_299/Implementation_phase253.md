...
### Changes
- Updated [`service.py`](/Users/sangyeol.park@gruve.ai/Documents/D5/development/ai_agent/ui/backend/service.py) so contact chat cards now include the `Send Message` action alongside `Open Record`, `Edit`, and `Delete`.
- Updated the contact chat-card hint copy so it mentions sending a message.
...
- Updated the contact card-action expectation in [`ai-agent-crud-contract.md`](/Users/sangyeol.park@gruve.ai/Documents/D5/development/docs/ai-agent-crud-contract.md).
